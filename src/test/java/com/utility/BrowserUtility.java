...
public abstract class BrowserUtility {
	...
	public void selectFromDropDown(By dropdDownLocator, String optionToSelect) {
		logger.info("Finding Element with the locator " + dropdDownLocator);
		WebElement element = driver.get().findElement(dropdDownLocator);
	...
	public List<String> getAllVisibleText(By locator) {
		...
		List<String> visitbleTextList = new ArrayList<String>();
		for (WebElement element : elementList) {
			System.out.println(getVisibleText(element));
			visitbleTextList.add(getVisibleText(element));
		}

		return visitbleTextList;
